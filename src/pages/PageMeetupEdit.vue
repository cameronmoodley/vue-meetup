<template>
  <div v-if="meetup && meetupCreator" class="meetup-detail-page">
    <section class="hero">
      <div class="hero-body">
        <div class="container">
          <h2 class="subtitle">
        ...
        <div class="is-pulled-right">
          ...
          <button
            ...
            @click.prevent="submitMeetupUpdates"
          >
            Update
          </button>
        </div>
...
export default {
  ...
  methods: {
    ...
    hasValue(meetup) {
      const meetupLen = Object.keys(meetup).length
      return meetupLen && meetupLen > 0
    },
    submitMeetupUpdates() {
...
.meetup-detail-page .hero-body > p,
h1,
h2,
strong {
  color: white;
...
.meetup-detail-page .meetup-side-box {
  background-color: white;
  border-radius: 10px;
  font-size: 16px;
  padding: 15px;
