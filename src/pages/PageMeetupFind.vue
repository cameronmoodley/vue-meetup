          ...
          <div class="level">
            <div class="level-left">
              ...
              <div v-if="category" class="level-item">
                <button class="button is-danger" @click="cancelCategory">
                  {{ category }} x
                </button>
              </div>
            </div>
...
.meetup-card-find .title {
  color: white;
}

.meetup-card-find .subtitle {
  color: white;
}

.meetup-card-find-info {
  position: absolute;
  bottom: 0;
  left: 0;
...
.meetup-card-find-content .month {
  display: block;
  color: #ff5050;
  font-weight: bold;
  font-size: 23px;
